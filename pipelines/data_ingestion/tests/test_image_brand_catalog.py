...
from pipelines.data_ingestion.image_brand_catalog import (
    get_prefix,
...
class TestGetPrefix:
    ...
    def test_get_prefix_raw(self):
        with patch("pipelines.data_ingestion.image_brand_catalog.Config") as mock_config:
...
class TestCreateImageCatalogue:
    ...
    def test_create_image_catalogue_basic(self):
        ...
        with patch(
            "pipelines.data_ingestion.image_brand_catalog.get_classes_in_img",
